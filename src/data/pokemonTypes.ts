...
const MEGA_SPRITE_MAP: Record<number, number> = {
  20003: 10033, 20006: 10034, 21006: 10035, 20009: 10036, 20065: 10037, 
  20094: 10038, 20115: 10039, 20127: 10040, 20130: 10041, 20142: 10042, 
  20150: 10043, 21150: 10044, 20181: 10045, 20212: 10046, 20214: 10047, 
  20229: 10048, 20248: 10049, 20257: 10050, 20282: 10051, 20303: 10052, 
  20306: 10053, 20308: 10054, 20310: 10055, 20354: 10056, 20359: 10057, 
  20445: 10058, 20448: 10059, 20460: 10060, 20015: 10090, 20018: 10091, 
  20080: 10092, 20208: 10093, 20254: 10094, 20260: 10095, 20302: 10096, 
  20319: 10097, 20323: 10098, 20334: 10099, 20362: 10100, 20373: 10101, 
  20376: 10102, 20380: 10062, 20381: 10063, 20384: 10079, 20428: 10103, 
  20475: 10104, 20531: 10105, 20719: 10106
};

export function getSpriteUrl(id: number): string {
  if (MEGA_SPRITE_MAP[id]) {
    return `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${MEGA_SPRITE_MAP[id]}.png`;
  }
  if (id >= 20000) {
    // Fallback for custom/rumored megas without official IDs
...
export const POKEMON_TYPE_DATA: PokemonEntry[] = [
  ...
  { id: 531, name: "Mega Audino", types: ["Normal", "Fairy"] },
  { id: 719, name: "Mega Diancie", types: ["Rock", "Fairy"] },
  { id: 154, name: "Mega Meganium", types: ["Grass", "Fairy"] },
  { id: 500, name: "Mega Emboar", types: ["Fire", "Fighting"] },
  { id: 160, name: "Mega Feraligatr", types: ["Water", "Dark"] },
  { id: 689, name: "Mega Barbaracle", types: ["Rock", "Water"] },
  { id: 121, name: "Mega Starmie", types: ["Water", "Psychic"] },
  { id: 668, name: "Mega Pyroar", types: ["Fire", "Normal"] },
  { id: 36, name: "Mega Clefable", types: ["Fairy"] },
  { id: 545, name: "Mega Scolipede", types: ["Bug", "Poison"] },
  { id: 71, name: "Mega Victreebel", types: ["Grass", "Poison"] },
  { id: 609, name: "Mega Chandelure", types: ["Ghost", "Fire"] },
  { id: 652, name: "Mega Chesnaught", types: ["Grass", "Fighting"] },
  { id: 655, name: "Mega Delphox", types: ["Fire", "Psychic"] },
  { id: 658, name: "Mega Greninja", types: ["Water", "Dark"] },
  { id: 691, name: "Mega Dragalge", types: ["Poison", "Dragon"] },
  { id: 149, name: "Mega Dragonite", types: ["Dragon", "Flying"] },
  { id: 780, name: "Mega Drampa", types: ["Normal", "Dragon"] },
  { id: 604, name: "Mega Eelektross", types: ["Electric"] },
  { id: 530, name: "Mega Excadrill", types: ["Ground", "Steel"] },
  { id: 870, name: "Mega Falinks", types: ["Fighting"] },
  { id: 478, name: "Mega Froslass", types: ["Ice", "Ghost"] },
  { id: 701, name: "Mega Hawlucha", types: ["Fighting", "Flying"] },
  { id: 687, name: "Mega Malamar", types: ["Dark", "Psychic"] },
  { id: 560, name: "Mega Scrafty", types: ["Dark", "Fighting"] },
  { id: 227, name: "Mega Skarmory", types: ["Steel", "Flying"] },
  { id: 718, name: "Mega Zygarde", types: ["Dragon", "Ground"] },
  { id: 26, name: "Mega Raichu X", types: ["Electric"] },
  { id: 26, name: "Mega Raichu Y", types: ["Electric"] },
  { id: 358, name: "Mega Chimecho", types: ["Psychic"] },
  { id: 998, name: "Mega Baxcalibur", types: ["Dragon", "Ice"] },
  { id: 623, name: "Mega Golurk", types: ["Ground", "Ghost"] },
  { id: 740, name: "Mega Crabominable", types: ["Fighting", "Ice"] },
  { id: 768, name: "Mega Golisopod", types: ["Bug", "Water"] },
  { id: 952, name: "Mega Scovillain", types: ["Grass", "Fire"] },
  { id: 970, name: "Mega Glimmora", types: ["Rock", "Poison"] },
  { id: 398, name: "Mega Staraptor", types: ["Normal", "Flying"] },
  { id: 678, name: "Mega Meowstic", types: ["Psychic"] },
  { id: 978, name: "Mega Tatsugiri", types: ["Dragon", "Water"] },
  { id: 485, name: "Mega Heatran", types: ["Fire", "Steel"] },
  { id: 491, name: "Mega Darkrai", types: ["Dark"] },
  { id: 807, name: "Mega Zeraora", types: ["Electric"] },
  { id: 801, name: "Mega Magearna", types: ["Steel", "Fairy"] },
  { id: 359, name: "Mega Absol Z", types: ["Dark"] },
  { id: 448, name: "Mega Lucario Z", types: ["Fighting", "Steel"] },
  { id: 445, name: "Mega Garchomp Z", types: ["Dragon", "Ground"] },
